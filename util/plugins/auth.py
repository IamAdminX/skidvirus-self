...
class api:
    ...
    def init(self):
        if self.sessionid != "":
            print(f"{Fore.BLUE} <*> You've already initialized!")
            time.sleep(3)
            os._exit(1)
        ...
        if json["message"] == "invalidver":
            if json["download"] != "":
                ...
                print(f"{Fore.BLUE} <*> Invalid Version, Contact owner to add download link to latest app version")
                time.sleep(3)
                os._exit(1)
    ...
    def register(self, user, password, license, hwid=None):
        ...
        if json["success"]:
            print(f"{Fore.BLUE} <*> Successfully registered")
    ...
    def upgrade(self, user, license):
        ...
        if json["success"]:
            print(f"{Fore.BLUE} <*> Successfully upgraded user")
            print(f"{Fore.BLUE} <*> Please restart program and login")
            time.sleep(3)
            os._exit(1)
        else:
            print(json["message"])
    ...
    def login(self, user, password, hwid=None):
        ...
        if json["success"]:
            self.__load_user_data(json["info"])
            print(f"{Fore.BLUE} <*> Successfully logged in")
        else:
            print(json["message"])
            time.sleep(3)
            os._exit(1)
    ...
    def license(self, key, hwid=None):
        ...
        if json["success"]:
            self.__load_user_data(json["info"])
            print(f"{Fore.BLUE} <*> Successfully logged in with license")
        else:
            print(json["message"])
            time.sleep(3)
            os._exit(1)
    ...
    def changeUsername(self, username):
        ...
        if json["success"]:
            print(f"{Fore.BLUE} <*> Successfully changed username")
        else:
            print(json["message"])
            time.sleep(3)
            os._exit(1)  
    ...
    def logout(self):
        ...
        if json["success"]:
            print(f"{Fore.BLUE} <*> Successfully logged out")
            time.sleep(3)
            os._exit(1)
        else:
            print(json["message"])
